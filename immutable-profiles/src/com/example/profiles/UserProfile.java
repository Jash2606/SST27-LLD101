...
public class UserProfile {
    ...
    public static class Builder{
        ...
        public static Builder from(UserProfile existing) {
            Builder b = new Builder(existing.id, existing.email);
            b.phone = existing.phone;
            b.displayName = existing.displayName;
            b.address = existing.address;
            b.marketingOptIn = existing.marketingOptIn;
            b.twitter = existing.twitter;
            b.github = existing.github;
            return b;
        }
